...
app.get("/home", (req, res) => {
  let sql = "(SELECT usuario.usuario_id, usuario.nombre, usuario.apellido, usuario.nombre_usuario, usuario.email, usuario.fotousuario, usuario.status, clases.clases_id, clases.titulo, clases.descripcion, clases.precio, clases.tema, clases.habilidad, clases.fecha, clases.plataforma, clases.foto FROM clases JOIN usuario ON (clases.usuario_id = usuario.usuario_id) WHERE clases.plataforma='presencial' ORDER BY clases.fecha DESC LIMIT 8) UNION ALL (SELECT usuario.usuario_id, usuario.nombre, usuario.apellido, usuario.nombre_usuario, usuario.email, usuario.fotousuario, usuario.status, clases.clases_id, clases.titulo, clases.descripcion, clases.precio, clases.tema, clases.habilidad, clases.fecha, clases.plataforma, clases.foto FROM clases JOIN usuario ON (clases.usuario_id = usuario.usuario_id) WHERE clases.plataforma='online' ORDER BY clases.fecha DESC LIMIT 8)";
...
app.get("/clases/miscameos", function (request, response) {
  let sql =
    "SELECT * FROM clases JOIN cameos ON(clases.clases_id = cameos.clases_id) JOIN usuario ON(clases.usuario_id = usuario.usuario_id) WHERE cameos.solicitante_id = ?";
